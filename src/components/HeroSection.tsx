...
export default function HeroSection({ onOpenQuoteModal, onScrollToServices }: HeroSectionProps) {
  return (
    <section id="inicio" className="relative w-full bg-[#0950F6] overflow-hidden pt-8 pb-16 lg:py-20 bg-tech-grid">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start z-10">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-10">
              <button
                ...
                className="flex items-center gap-2.5 px-8 py-3.5 rounded-full bg-[#ffcc00] hover:bg-[#ffd633] text-[#002273] font-bebas text-2xl tracking-wider uppercase transition-all transform hover:scale-[1.03] active:scale-[0.98] glow-yellow shadow-xl cursor-pointer"
              ...
              >
                ...
                <span className="w-7 h-7 rounded-full bg-[#002273]/15 flex items-center justify-center">
                  <ArrowRight className="w-4 h-4 text-[#002273] stroke-[2.5]" />
                </span>
              </button>

              <button
                onClick={onScrollToServices}
                className="flex items-center gap-2 px-7 py-3.5 rounded-full bg-[#032a87]/60 hover:bg-[#032a87] text-white border border-blue-300/30 font-bebas text-2xl tracking-wider uppercase transition-all transform hover:scale-[1.02] cursor-pointer"
                id="hero-btn-servicios"
              >
                <span>MIRÁ LOS SERVICIOS</span>
                <ArrowRight className="w-4 h-4 text-blue-200 stroke-[2]" />
              </button>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-2 border-t border-blue-400/20 text-xs sm:text-sm">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-blue-900/40 border border-blue-400/20 text-white font-bebas tracking-wide">
                <div className="w-6 h-6 rounded-lg bg-[#ffcc00]/20 flex items-center justify-center">
                  <FastForward className="w-3.5 h-3.5 text-[#ffcc00]" />
                </div>
          ...
          {/* Right Column: Interactive Dispatch Visual Card (Exact layout from Image 1) */}
          <div className="lg:col-span-5 flex justify-center z-10">
            <div className="w-full max-w-md bg-[#00277e]/90 border border-blue-400/30 rounded-[32px] p-4 sm:p-5 shadow-2xl backdrop-blur-md relative overflow-hidden group hover:border-blue-400/60 transition-all">
              ...
              <div className="relative my-4 rounded-2xl bg-[#02184a] border border-blue-500/20 p-4 h-64 sm:h-72 flex flex-col items-center justify-center overflow-hidden">
                ...
                {/* Isometric Styled Buildings Illustration */}
                <svg
                ...
                >
                  ...
                  {/* Glowing Golden Logistics Route Lines */}
                  <path
                  ...
                  {/* Small dispatched motorcycle indicator */}
                  <circle cx="110" cy="125" r="5" fill="#ffffff" stroke="#ffcc00" strokeWidth="2" />
                </svg>

                {/* Big Pin Badge: "ENVIOS DosRuedas MDQ" */}
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                <div className="flex items-center gap-2.5 p-3 rounded-2xl bg-[#031d5b] border border-blue-400/20">
                  <div className="w-8 h-8 rounded-xl bg-[#ffcc00] flex items-center justify-center flex-shrink-0 shadow">
                    <Zap className="w-4 h-4 text-[#002273] fill-[#002273]" />
                  </div>
