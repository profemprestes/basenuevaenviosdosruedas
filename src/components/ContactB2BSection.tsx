          ...
          <div className="lg:col-span-6">
            <Card variant="bento-white" padding="xl" className="rounded-[32px] border-4 border-blue-400/20 bg-light-grid">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {submitted && (
                  <div aria-live="polite" className="animate-in fade-in zoom-in-95 duration-300 ease-out-expo mt-4 p-3 rounded-xl bg-emerald-50 border border-emerald-200 flex items-center gap-2 text-emerald-800 text-xs font-outfit">
