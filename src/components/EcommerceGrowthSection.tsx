    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-14">
          ...
          <div className="w-20 h-1.5 bg-[#ffcc00] rounded-full mb-6" aria-hidden="true" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch mb-20">
          ...
          <article className="lg:col-span-6 bg-[#00277e]/90 border border-blue-400/30 rounded-[32px] p-7 sm:p-9 text-white shadow-2xl backdrop-blur-md flex flex-col justify-between relative overflow-hidden">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-lg bg-blue-600/50 border border-blue-400/40 flex items-center justify-center flex-shrink-0">
                    <Check className="w-4 h-4 text-[#ffcc00] stroke-[3]" aria-hidden="true" />
                  </div>
            ...
            <div className="pt-4 border-t border-blue-400/20">
              <button
                ...
                className="inline-flex items-center gap-2 px-7 py-3 rounded-full bg-[#ffcc00] hover:bg-[#ffd633] text-[#002273] font-bebas text-xl tracking-wider uppercase transition-all transform hover:scale-[1.03] shadow-lg glow-yellow cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#002273]"
              >
          ...
          <div className="lg:col-span-6 flex flex-col gap-6">
            <article className="bg-[#ffcc00] rounded-[32px] p-7 sm:p-8 text-[#002273] shadow-xl relative overflow-hidden flex flex-col justify-between group hover:scale-[1.01] transition-transform">
              <div>
                <div className="flex items-center justify-between mb-5">
                  <div className="w-12 h-12 rounded-2xl bg-[#002273] flex items-center justify-center text-white shadow">
                    <ShoppingBag className="w-6 h-6 text-[#ffcc00]" aria-hidden="true" />
                  </div>
              ...
              <div>
                <button
                  ...
                  className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-[#002273] hover:bg-[#00174e] text-white font-bebas text-lg tracking-wider uppercase transition-all shadow-md cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#ffcc00]"
                >
            ...
            <article className="bg-white rounded-[32px] p-7 sm:p-8 text-slate-900 shadow-xl border border-slate-200/90 flex flex-col justify-between group hover:scale-[1.01] transition-transform">
              ...
              <div>
                <button
                  type="button"
                  onClick={onOpenQuoteModal}
                  className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-[#ffcc00] hover:bg-[#ffd633] text-[#002273] font-bebas text-lg tracking-wider uppercase transition-all shadow-md cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#002273]"
                >
